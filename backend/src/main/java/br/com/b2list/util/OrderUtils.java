...
public class OrderUtils {
    ...
    public static ResponseEntity<ErrorResponseDTO> checkIfExternalReferenceIsPresent(OrderRequestDTO orderRequestDTO) {
        if (orderRequestDTO.getExternalReference() == null) {
            ErrorResponseDTO errorResponseDTO = ErrorUtil.buildErrorResponse(br.com.b2list.enums.Error.ORD_VALIDATION_006);
            List<String> details = List.of(
    ...
    public static ResponseEntity<ErrorResponseDTO> validateProductPrice(OrderRequestDTO.ItemDTO itemDTO, ProductPrice productPrice) {
